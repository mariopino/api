...
*Defined in [types.ts:67](https://github.com/polkadot-js/api/blob/9c09386/packages/api/src/types.ts#L67)*
...
*Defined in [types.ts:68](https://github.com/polkadot-js/api/blob/9c09386/packages/api/src/types.ts#L68)*
...
*Defined in [types.ts:69](https://github.com/polkadot-js/api/blob/9c09386/packages/api/src/types.ts#L69)*
...
*Defined in [types.ts:70](https://github.com/polkadot-js/api/blob/9c09386/packages/api/src/types.ts#L70)*
