...
*Defined in [submittable/types.ts:21](https://github.com/polkadot-js/api/blob/05d697c/packages/api/src/submittable/types.ts#L21)*
...
*Defined in [submittable/types.ts:22](https://github.com/polkadot-js/api/blob/05d697c/packages/api/src/submittable/types.ts#L22)*