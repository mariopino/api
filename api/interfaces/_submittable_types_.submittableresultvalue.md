...
*Defined in [submittable/types.ts:21](https://github.com/polkadot-js/api/blob/587c988/packages/api/src/submittable/types.ts#L21)*
...
*Defined in [submittable/types.ts:22](https://github.com/polkadot-js/api/blob/587c988/packages/api/src/submittable/types.ts#L22)*