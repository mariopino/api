...
*Defined in [submittable/types.ts:21](https://github.com/polkadot-js/api/blob/5d2cadd/packages/api/src/submittable/types.ts#L21)*
...
*Defined in [submittable/types.ts:22](https://github.com/polkadot-js/api/blob/5d2cadd/packages/api/src/submittable/types.ts#L22)*