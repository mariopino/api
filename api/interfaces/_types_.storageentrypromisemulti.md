...
*Defined in [types.ts:109](https://github.com/polkadot-js/api/blob/73d7a57/packages/api/src/types.ts#L109)*
...
*Defined in [types.ts:110](https://github.com/polkadot-js/api/blob/73d7a57/packages/api/src/types.ts#L110)*
