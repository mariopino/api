...
*Defined in [types.ts:105](https://github.com/polkadot-js/api/blob/417a9ff/packages/api/src/types.ts#L105)*
...
*Defined in [types.ts:106](https://github.com/polkadot-js/api/blob/417a9ff/packages/api/src/types.ts#L106)*
