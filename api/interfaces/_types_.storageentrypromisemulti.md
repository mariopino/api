...
*Defined in [types.ts:109](https://github.com/polkadot-js/api/blob/564964a/packages/api/src/types.ts#L109)*
...
*Defined in [types.ts:110](https://github.com/polkadot-js/api/blob/564964a/packages/api/src/types.ts#L110)*
