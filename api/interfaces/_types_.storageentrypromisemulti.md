...
*Defined in [types.ts:109](https://github.com/polkadot-js/api/blob/a3b0dde/packages/api/src/types.ts#L109)*
...
*Defined in [types.ts:110](https://github.com/polkadot-js/api/blob/a3b0dde/packages/api/src/types.ts#L110)*
