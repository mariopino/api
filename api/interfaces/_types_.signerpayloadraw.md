...
*Defined in [types.ts:285](https://github.com/polkadot-js/api/blob/bc3d21b/packages/api/src/types.ts#L285)*
...
*Defined in [types.ts:290](https://github.com/polkadot-js/api/blob/bc3d21b/packages/api/src/types.ts#L290)*
