...
*Defined in [types.ts:95](https://github.com/polkadot-js/api/blob/f8ec93a/packages/api/src/types.ts#L95)*
...
*Defined in [types.ts:96](https://github.com/polkadot-js/api/blob/f8ec93a/packages/api/src/types.ts#L96)*
...
*Defined in [types.ts:98](https://github.com/polkadot-js/api/blob/f8ec93a/packages/api/src/types.ts#L98)*
