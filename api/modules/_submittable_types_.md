...
*Defined in [submittable/types.ts:25](https://github.com/polkadot-js/api/blob/fadb1ff/packages/api/src/submittable/types.ts#L25)*
...
*Defined in [submittable/types.ts:30](https://github.com/polkadot-js/api/blob/fadb1ff/packages/api/src/submittable/types.ts#L30)*
