...
*Defined in [submittable/types.ts:26](https://github.com/polkadot-js/api/blob/cba5710fec/packages/api/src/submittable/types.ts#L26)*
...
*Defined in [submittable/types.ts:31](https://github.com/polkadot-js/api/blob/cba5710fec/packages/api/src/submittable/types.ts#L31)*
