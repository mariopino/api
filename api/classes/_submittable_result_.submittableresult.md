...
*Defined in [submittable/Result.ts:11](https://github.com/polkadot-js/api/blob/a0b8619/packages/api/src/submittable/Result.ts#L11)*
...
*Defined in [submittable/Result.ts:9](https://github.com/polkadot-js/api/blob/a0b8619/packages/api/src/submittable/Result.ts#L9)*
...
*Defined in [submittable/Result.ts:18](https://github.com/polkadot-js/api/blob/a0b8619/packages/api/src/submittable/Result.ts#L18)*
...
*Defined in [submittable/Result.ts:22](https://github.com/polkadot-js/api/blob/a0b8619/packages/api/src/submittable/Result.ts#L22)*
...
*Defined in [submittable/Result.ts:26](https://github.com/polkadot-js/api/blob/a0b8619/packages/api/src/submittable/Result.ts#L26)*
...
*Defined in [submittable/Result.ts:33](https://github.com/polkadot-js/api/blob/a0b8619/packages/api/src/submittable/Result.ts#L33)*
