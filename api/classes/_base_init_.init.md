...
*Defined in [base/Init.ts:57](https://github.com/polkadot-js/api/blob/9c09386/packages/api/src/base/Init.ts#L57)*
...
*Defined in [base/Init.ts:82](https://github.com/polkadot-js/api/blob/9c09386/packages/api/src/base/Init.ts#L82)*
