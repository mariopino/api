...
*Defined in [base/Init.ts:50](https://github.com/polkadot-js/api/blob/564964a/packages/api/src/base/Init.ts#L50)*
...
*Defined in [base/Init.ts:75](https://github.com/polkadot-js/api/blob/564964a/packages/api/src/base/Init.ts#L75)*
