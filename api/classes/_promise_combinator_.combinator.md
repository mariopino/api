...
*Defined in [promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/417a9ff/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [promise/Combinator.ts:74](https://github.com/polkadot-js/api/blob/417a9ff/packages/api/src/promise/Combinator.ts#L74)*
