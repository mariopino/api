...
*Defined in [promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/05d697c/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [promise/Combinator.ts:76](https://github.com/polkadot-js/api/blob/05d697c/packages/api/src/promise/Combinator.ts#L76)*
