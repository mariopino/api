...
*Defined in [promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/f080d6ed1c/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [promise/Combinator.ts:76](https://github.com/polkadot-js/api/blob/f080d6ed1c/packages/api/src/promise/Combinator.ts#L76)*
