...
*Defined in [democracy/referendumVotesFor.ts:18](https://github.com/polkadot-js/api/blob/9c09386/packages/api-derive/src/democracy/referendumVotesFor.ts#L18)*
