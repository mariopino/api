...
*Defined in [democracy/referendumInfo.ts:17](https://github.com/polkadot-js/api/blob/87f195d/packages/api-derive/src/democracy/referendumInfo.ts#L17)*
...
*Defined in [democracy/referendumInfo.ts:30](https://github.com/polkadot-js/api/blob/87f195d/packages/api-derive/src/democracy/referendumInfo.ts#L30)*
