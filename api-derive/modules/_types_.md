...
*Defined in [types.ts:21](https://github.com/polkadot-js/api/blob/26c2774992/packages/api-derive/src/types.ts#L21)*
...
*Defined in [types.ts:60](https://github.com/polkadot-js/api/blob/26c2774992/packages/api-derive/src/types.ts#L60)*
...
*Defined in [types.ts:81](https://github.com/polkadot-js/api/blob/26c2774992/packages/api-derive/src/types.ts#L81)*
...
*Defined in [types.ts:83](https://github.com/polkadot-js/api/blob/26c2774992/packages/api-derive/src/types.ts#L83)*
...
*Defined in [types.ts:115](https://github.com/polkadot-js/api/blob/26c2774992/packages/api-derive/src/types.ts#L115)*
...
*Defined in [types.ts:123](https://github.com/polkadot-js/api/blob/26c2774992/packages/api-derive/src/types.ts#L123)*
