...
*Defined in [types.ts:20](https://github.com/polkadot-js/api/blob/564964a/packages/api-derive/src/types.ts#L20)*
...
*Defined in [types.ts:59](https://github.com/polkadot-js/api/blob/564964a/packages/api-derive/src/types.ts#L59)*
...
*Defined in [types.ts:80](https://github.com/polkadot-js/api/blob/564964a/packages/api-derive/src/types.ts#L80)*
...
*Defined in [types.ts:82](https://github.com/polkadot-js/api/blob/564964a/packages/api-derive/src/types.ts#L82)*
...
*Defined in [types.ts:114](https://github.com/polkadot-js/api/blob/564964a/packages/api-derive/src/types.ts#L114)*
...
*Defined in [types.ts:122](https://github.com/polkadot-js/api/blob/564964a/packages/api-derive/src/types.ts#L122)*