...
*Defined in [chain/subscribeNewHeads.ts:14](https://github.com/polkadot-js/api/blob/2dd7cc0/packages/api-derive/src/chain/subscribeNewHeads.ts#L14)*
...
*Defined in [chain/subscribeNewHeads.ts:29](https://github.com/polkadot-js/api/blob/2dd7cc0/packages/api-derive/src/chain/subscribeNewHeads.ts#L29)*
