...
*Defined in [codec/utils/mapToTypeMap.ts:22](https://github.com/polkadot-js/api/blob/5d2cadd/packages/types/src/codec/utils/mapToTypeMap.ts#L22)*
...
*Defined in [codec/utils/mapToTypeMap.ts:11](https://github.com/polkadot-js/api/blob/5d2cadd/packages/types/src/codec/utils/mapToTypeMap.ts#L11)*
