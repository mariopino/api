...
*Defined in [scripts/generateTypes/interfaceRegistry.ts:19](https://github.com/polkadot-js/api/blob/26c2774992/packages/types/src/scripts/generateTypes/interfaceRegistry.ts#L19)*
