...
*Defined in [scripts/generateTypes/interfaceRegistry.ts:19](https://github.com/polkadot-js/api/blob/479c742471/packages/types/src/scripts/generateTypes/interfaceRegistry.ts#L19)*
