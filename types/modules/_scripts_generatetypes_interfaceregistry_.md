...
*Defined in [scripts/generateTypes/interfaceRegistry.ts:19](https://github.com/polkadot-js/api/blob/9693766/packages/types/src/scripts/generateTypes/interfaceRegistry.ts#L19)*
