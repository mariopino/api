...
*Defined in [codec/create/createType.ts:60](https://github.com/polkadot-js/api/blob/05ec496/packages/types/src/codec/create/createType.ts#L60)*
...
*Defined in [codec/create/createType.ts:46](https://github.com/polkadot-js/api/blob/05ec496/packages/types/src/codec/create/createType.ts#L46)*
