...
*Defined in [codec/create/createType.ts:74](https://github.com/polkadot-js/api/blob/5b5d0a3fb8/packages/types/src/codec/create/createType.ts#L74)*
...
*Defined in [codec/create/createType.ts:60](https://github.com/polkadot-js/api/blob/5b5d0a3fb8/packages/types/src/codec/create/createType.ts#L60)*
