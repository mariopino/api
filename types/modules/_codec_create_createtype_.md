...
*Defined in [codec/create/createType.ts:59](https://github.com/polkadot-js/api/blob/6ec3815/packages/types/src/codec/create/createType.ts#L59)*
...
*Defined in [codec/create/createType.ts:45](https://github.com/polkadot-js/api/blob/6ec3815/packages/types/src/codec/create/createType.ts#L45)*
