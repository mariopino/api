...
*Defined in [scripts/util/derived.ts:17](https://github.com/polkadot-js/api/blob/b2daf7482f/packages/types/src/scripts/util/derived.ts#L17)*
...
*Defined in [scripts/util/derived.ts:37](https://github.com/polkadot-js/api/blob/b2daf7482f/packages/types/src/scripts/util/derived.ts#L37)*
