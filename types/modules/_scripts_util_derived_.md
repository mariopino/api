...
*Defined in [scripts/util/derived.ts:17](https://github.com/polkadot-js/api/blob/8d0f20c2a7/packages/types/src/scripts/util/derived.ts#L17)*
...
*Defined in [scripts/util/derived.ts:37](https://github.com/polkadot-js/api/blob/8d0f20c2a7/packages/types/src/scripts/util/derived.ts#L37)*
