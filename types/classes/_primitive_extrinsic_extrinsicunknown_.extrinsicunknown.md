...
*Defined in [primitive/Extrinsic/ExtrinsicUnknown.ts:15](https://github.com/polkadot-js/api/blob/1584100/packages/types/src/primitive/Extrinsic/ExtrinsicUnknown.ts#L15)*
