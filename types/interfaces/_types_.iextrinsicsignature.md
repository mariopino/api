...
*Defined in [types.ts:194](https://github.com/polkadot-js/api/blob/fadb1ff/packages/types/src/types.ts#L194)*
...
*Defined in [types.ts:195](https://github.com/polkadot-js/api/blob/fadb1ff/packages/types/src/types.ts#L195)*
