...
*Defined in [types.ts:189](https://github.com/polkadot-js/api/blob/db9dcbd/packages/types/src/types.ts#L189)*
...
*Defined in [types.ts:190](https://github.com/polkadot-js/api/blob/db9dcbd/packages/types/src/types.ts#L190)*
