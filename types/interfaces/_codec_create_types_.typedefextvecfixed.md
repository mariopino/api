...
*Defined in [codec/create/types.ts:32](https://github.com/polkadot-js/api/blob/05ec496/packages/types/src/codec/create/types.ts#L32)*
...
*Defined in [codec/create/types.ts:33](https://github.com/polkadot-js/api/blob/05ec496/packages/types/src/codec/create/types.ts#L33)*
