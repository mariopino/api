...
*Defined in [codec/create/types.ts:33](https://github.com/polkadot-js/api/blob/8d0f20c2a7/packages/types/src/codec/create/types.ts#L33)*
...
*Defined in [codec/create/types.ts:34](https://github.com/polkadot-js/api/blob/8d0f20c2a7/packages/types/src/codec/create/types.ts#L34)*
