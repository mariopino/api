...
*Defined in [codec/create/types.ts:33](https://github.com/polkadot-js/api/blob/de395c7053/packages/types/src/codec/create/types.ts#L33)*
...
*Defined in [codec/create/types.ts:34](https://github.com/polkadot-js/api/blob/de395c7053/packages/types/src/codec/create/types.ts#L34)*
