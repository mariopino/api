...
*Defined in [codec/create/types.ts:31](https://github.com/polkadot-js/api/blob/00d8601/packages/types/src/codec/create/types.ts#L31)*
...
*Defined in [codec/create/types.ts:32](https://github.com/polkadot-js/api/blob/00d8601/packages/types/src/codec/create/types.ts#L32)*