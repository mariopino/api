...
*Defined in [types.ts:293](https://github.com/polkadot-js/api/blob/cf07d4f/packages/types/src/types.ts#L293)*
...
*Defined in [types.ts:298](https://github.com/polkadot-js/api/blob/cf07d4f/packages/types/src/types.ts#L298)*
