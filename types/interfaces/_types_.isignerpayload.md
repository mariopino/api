...
*Defined in [types.ts:298](https://github.com/polkadot-js/api/blob/05d697c/packages/types/src/types.ts#L298)*
...
*Defined in [types.ts:299](https://github.com/polkadot-js/api/blob/05d697c/packages/types/src/types.ts#L299)*
