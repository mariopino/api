...
*Defined in [types.ts:303](https://github.com/polkadot-js/api/blob/17a10fb/packages/types/src/types.ts#L303)*
...
*Defined in [types.ts:304](https://github.com/polkadot-js/api/blob/17a10fb/packages/types/src/types.ts#L304)*
