...
*Defined in [types.ts:298](https://github.com/polkadot-js/api/blob/f8ec93a/packages/types/src/types.ts#L298)*
...
*Defined in [types.ts:299](https://github.com/polkadot-js/api/blob/f8ec93a/packages/types/src/types.ts#L299)*
