...
*Defined in [types.ts:304](https://github.com/polkadot-js/api/blob/cba5710fec/packages/types/src/types.ts#L304)*
...
*Defined in [types.ts:305](https://github.com/polkadot-js/api/blob/cba5710fec/packages/types/src/types.ts#L305)*
