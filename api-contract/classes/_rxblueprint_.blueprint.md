...
*Defined in [RxBlueprint.ts:38](https://github.com/polkadot-js/api/blob/ad4a6e6/packages/api-contract/src/RxBlueprint.ts#L38)*
...
*Defined in [RxBlueprint.ts:46](https://github.com/polkadot-js/api/blob/ad4a6e6/packages/api-contract/src/RxBlueprint.ts#L46)*
