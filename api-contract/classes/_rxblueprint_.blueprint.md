...
*Defined in [RxBlueprint.ts:38](https://github.com/polkadot-js/api/blob/8b80ce7/packages/api-contract/src/RxBlueprint.ts#L38)*
...
*Defined in [RxBlueprint.ts:46](https://github.com/polkadot-js/api/blob/8b80ce7/packages/api-contract/src/RxBlueprint.ts#L46)*
