...
*Defined in [RxBlueprint.ts:39](https://github.com/polkadot-js/api/blob/30f62f4024/packages/api-contract/src/RxBlueprint.ts#L39)*
...
*Defined in [RxBlueprint.ts:47](https://github.com/polkadot-js/api/blob/30f62f4024/packages/api-contract/src/RxBlueprint.ts#L47)*
