...
*Defined in [RxBlueprint.ts:39](https://github.com/polkadot-js/api/blob/6e96fd6a55/packages/api-contract/src/RxBlueprint.ts#L39)*
...
*Defined in [RxBlueprint.ts:47](https://github.com/polkadot-js/api/blob/6e96fd6a55/packages/api-contract/src/RxBlueprint.ts#L47)*
