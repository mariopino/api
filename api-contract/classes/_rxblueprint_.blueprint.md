...
*Defined in [RxBlueprint.ts:38](https://github.com/polkadot-js/api/blob/0f21d52/packages/api-contract/src/RxBlueprint.ts#L38)*
...
*Defined in [RxBlueprint.ts:46](https://github.com/polkadot-js/api/blob/0f21d52/packages/api-contract/src/RxBlueprint.ts#L46)*
