...
\+ **new RxContract**(`api`: ApiRx, `abi`: [ContractABIPre](../interfaces/_types_.contractabipre.md) | Abi, `address`: string | AccountId | Address): *[RxContract](_rxcontract_.rxcontract.md)*

*Overrides [RxBase](_rxbase_.rxbase.md).[constructor](_rxbase_.rxbase.md#constructor)*

*Defined in [RxContract.ts:28](https://github.com/polkadot-js/api/blob/3196e66efb/packages/api-contract/src/RxContract.ts#L28)*
...
*Defined in [RxBase.ts:14](https://github.com/polkadot-js/api/blob/3196e66efb/packages/api-contract/src/RxBase.ts#L14)*
...
*Defined in [RxContract.ts:26](https://github.com/polkadot-js/api/blob/3196e66efb/packages/api-contract/src/RxContract.ts#L26)*
...
*Defined in [RxBase.ts:16](https://github.com/polkadot-js/api/blob/3196e66efb/packages/api-contract/src/RxBase.ts#L16)*
...
*Defined in [RxBase.ts:18](https://github.com/polkadot-js/api/blob/3196e66efb/packages/api-contract/src/RxBase.ts#L18)*
