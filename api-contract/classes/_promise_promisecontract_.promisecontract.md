...
*Defined in [promise/PromiseContract.ts:14](https://github.com/polkadot-js/api/blob/f080d6ed1c/packages/api-contract/src/promise/PromiseContract.ts#L14)*
...
*Defined in [base/Contract.ts:35](https://github.com/polkadot-js/api/blob/f080d6ed1c/packages/api-contract/src/base/Contract.ts#L35)*
...
*Defined in [base/Contract.ts:37](https://github.com/polkadot-js/api/blob/f080d6ed1c/packages/api-contract/src/base/Contract.ts#L37)*
...
*Defined in [base/Contract.ts:38](https://github.com/polkadot-js/api/blob/f080d6ed1c/packages/api-contract/src/base/Contract.ts#L38)*
