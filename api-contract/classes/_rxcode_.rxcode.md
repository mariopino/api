...
*Defined in [RxCode.ts:51](https://github.com/polkadot-js/api/blob/00d8601/packages/api-contract/src/RxCode.ts#L51)*
...
*Defined in [RxBase.ts:14](https://github.com/polkadot-js/api/blob/00d8601/packages/api-contract/src/RxBase.ts#L14)*
...
*Defined in [RxBase.ts:16](https://github.com/polkadot-js/api/blob/00d8601/packages/api-contract/src/RxBase.ts#L16)*
...
*Defined in [RxBase.ts:18](https://github.com/polkadot-js/api/blob/00d8601/packages/api-contract/src/RxBase.ts#L18)*
...
*Defined in [RxCode.ts:59](https://github.com/polkadot-js/api/blob/00d8601/packages/api-contract/src/RxCode.ts#L59)*
