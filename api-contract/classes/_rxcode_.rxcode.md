...
*Defined in [RxCode.ts:51](https://github.com/polkadot-js/api/blob/35622a9/packages/api-contract/src/RxCode.ts#L51)*
...
*Defined in [RxCode.ts:59](https://github.com/polkadot-js/api/blob/35622a9/packages/api-contract/src/RxCode.ts#L59)*
