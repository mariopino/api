...
*Defined in [types.ts:74](https://github.com/polkadot-js/api/blob/692c208/packages/api-contract/src/types.ts#L74)*
...
*Defined in [types.ts:75](https://github.com/polkadot-js/api/blob/692c208/packages/api-contract/src/types.ts#L75)*
...
*Defined in [types.ts:76](https://github.com/polkadot-js/api/blob/692c208/packages/api-contract/src/types.ts#L76)*