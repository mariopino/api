...
*Defined in [types.ts:90](https://github.com/polkadot-js/api/blob/9693766/packages/api-contract/src/types.ts#L90)*
...
*Defined in [types.ts:91](https://github.com/polkadot-js/api/blob/9693766/packages/api-contract/src/types.ts#L91)*
