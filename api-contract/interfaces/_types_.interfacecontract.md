...
*Defined in [types.ts:183](https://github.com/polkadot-js/api/blob/26c2774992/packages/api-contract/src/types.ts#L183)*
...
*Defined in [types.ts:184](https://github.com/polkadot-js/api/blob/26c2774992/packages/api-contract/src/types.ts#L184)*
