...
*Defined in [types.ts:91](https://github.com/polkadot-js/api/blob/05ec496/packages/api-contract/src/types.ts#L91)*
...
*Defined in [types.ts:92](https://github.com/polkadot-js/api/blob/05ec496/packages/api-contract/src/types.ts#L92)*
