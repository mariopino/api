...
*Defined in [types.ts:57](https://github.com/polkadot-js/api/blob/9693766/packages/api-contract/src/types.ts#L57)*
...
*Defined in [types.ts:58](https://github.com/polkadot-js/api/blob/9693766/packages/api-contract/src/types.ts#L58)*
