...
*Defined in [types.ts:57](https://github.com/polkadot-js/api/blob/b36660a/packages/api-contract/src/types.ts#L57)*
...
*Defined in [types.ts:58](https://github.com/polkadot-js/api/blob/b36660a/packages/api-contract/src/types.ts#L58)*
