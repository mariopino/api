...
*Defined in [types.ts:35](https://github.com/polkadot-js/api/blob/67929d3/packages/api-contract/src/types.ts#L35)*
...
*Defined in [types.ts:36](https://github.com/polkadot-js/api/blob/67929d3/packages/api-contract/src/types.ts#L36)*