...
*Defined in [types.ts:51](https://github.com/polkadot-js/api/blob/b36660a/packages/api-contract/src/types.ts#L51)*
...
*Defined in [types.ts:52](https://github.com/polkadot-js/api/blob/b36660a/packages/api-contract/src/types.ts#L52)*
...
*Defined in [types.ts:53](https://github.com/polkadot-js/api/blob/b36660a/packages/api-contract/src/types.ts#L53)*
