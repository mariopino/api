...
*Defined in [types.ts:51](https://github.com/polkadot-js/api/blob/17a10fb/packages/api-contract/src/types.ts#L51)*
...
*Defined in [types.ts:52](https://github.com/polkadot-js/api/blob/17a10fb/packages/api-contract/src/types.ts#L52)*
...
*Defined in [types.ts:53](https://github.com/polkadot-js/api/blob/17a10fb/packages/api-contract/src/types.ts#L53)*
