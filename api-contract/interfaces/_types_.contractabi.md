...
*Defined in [types.ts:87](https://github.com/polkadot-js/api/blob/9086592252/packages/api-contract/src/types.ts#L87)*
...
*Defined in [types.ts:86](https://github.com/polkadot-js/api/blob/9086592252/packages/api-contract/src/types.ts#L86)*
