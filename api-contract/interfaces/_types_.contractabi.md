...
*Defined in [types.ts:96](https://github.com/polkadot-js/api/blob/479c742471/packages/api-contract/src/types.ts#L96)*
...
*Defined in [types.ts:95](https://github.com/polkadot-js/api/blob/479c742471/packages/api-contract/src/types.ts#L95)*
